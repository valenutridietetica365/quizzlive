...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-white selection:bg-blue-100 italic-none">
            ...
            {/* Hero Section */}
            <section className="pt-32 md:pt-48 pb-20 md:pb-32 px-6 relative overflow-hidden">
            ...
            <section className="py-20 border-y border-slate-50 bg-white" id="features">
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
                    <div className="flex flex-col items-center text-center space-y-4 p-8 rounded-3xl hover:bg-slate-50 transition-colors">
