...
export default function StudentPlay() {
    ...
    const handleNewQuestion = async (questionId: string) => {
                ...
                <div className="max-w-md w-full text-center space-y-8 animate-in zoom-in duration-500">
                    <div className="bg-white p-12 rounded-[3rem] shadow-xl border border-slate-100 flex flex-col items-center gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-500 font-medium">Bienvenido, <span className="text-blue-600 font-bold">{nickname}</span>. Espera a que la profesora inicie el quiz.</p>
                        </div>
