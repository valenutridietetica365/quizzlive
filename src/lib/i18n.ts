...
export const translations = {
    es: {
        ...
        dashboard: {
            ...
            'teams.desc': 'Competición grupal.',
            'roulette.name': 'Modo Ruleta',
            'roulette.desc': 'Participación aleatoria dirigida por el profesor.',
            'roulette.spin_participant': 'Girar para elegir Alumno',
            'roulette.spin_question': 'Girar para elegir Pregunta',
            'roulette.selected_participant': '{name}',
            'roulette.selected_question': 'Tu desafío es:',
            'roulette.your_turn': '¡ES TU TURNO!',
            'roulette.answering': '{name} está respondiendo...',
            'roulette.correct': '¡Correcto!',
            'roulette.incorrect': 'Incorrecto',
            'roulette.manual_points': 'Puntos a otorgar',
            'roulette.waiting_spin': 'Esperando a que el profesor gire la ruleta...',
            'roulette.instruction': 'Responde en voz alta y el profesor te dará los puntos.',
    ...
    en: {
        common: {
            ...
            students: "students",
            questions: "questions",
            'teams.desc': 'Group competition.',
            'roulette.name': 'Roulette Mode',
            'roulette.desc': 'Random participation led by the teacher.',
            'roulette.spin_participant': 'Spin to pick Student',
            'roulette.spin_question': 'Spin to pick Question',
            'roulette.selected_participant': '{name}',
            'roulette.selected_question': 'Your challenge is:',
            'roulette.your_turn': "IT'S YOUR TURN!",
            'roulette.answering': '{name} is answering...',
            'roulette.correct': 'Correct!',
            'roulette.incorrect': 'Incorrect',
            'roulette.manual_points': 'Points to award',
            'roulette.waiting_spin': "Waiting for the teacher to spin the wheel...",
            'roulette.instruction': 'Answer out loud and the teacher will give you points.',
            logout: "Logout"
        },
        dashboard: {
            title: "My Quizzes",
