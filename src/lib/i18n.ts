...
export const translations = {
    es: {
        ...
        dashboard: {
            ...
            'teams': {
                'desc': 'Competición grupal.',
            },
            'roulette': {
                'name': 'Modo Ruleta',
                'desc': 'Participación aleatoria dirigida por el profesor.',
                'spin_participant': 'Girar para elegir Alumno',
                'spin_question': 'Girar para elegir Pregunta',
                'selected_participant': '{name}',
                'selected_question': 'Tu desafío es:',
                'your_turn': '¡ES TU TURNO!',
                'answering': '{name} está respondiendo...',
                'correct': '¡Correcto!',
                'incorrect': 'Incorrecto',
                'manual_points': 'Puntos a otorgar',
                'waiting_spin': 'Esperando a que el profesor gire la ruleta...',
                'instruction': 'Responde en voz alta y el profesor te dará los puntos.',
            },
